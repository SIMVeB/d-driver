        ...
        <section id="form" class="form">
            <div class="container" data-aos="fade-up">
                ...
                <div class="row content">
                    ...
                    <form method="POST" action="{{ route('owner-modify', $owner->id) }}">
                        @csrf
                        ...
                        <div class="d-flex justify-content-between mt-3">
                            ...
                            <button type="submit" class="v-driver-btn-outline-primary">Mise à jour <i
                            ...
                            <tbody>
                                @foreach ($vehicles as $key => $vehicle)
                                    <tr>
                                        ...
                                        <td>{{ $vehicle->driver == null ? '' : $vehicle->owner->email }}

                                            @if ($vehicle->driver != null && $vehicle->owner->email != null && $vehicle->owner->phoneNumber != null)
                                                /
                                            @endif
                                            {{ $vehicle->driver == null ? '' : $vehicle->owner->phoneNumber }}
                                        </td>
